...
<script>
			...
			var MaterialRoughness = new Array(new Array(0.05, 0.75, 0.1), new Array(0.025, 0.15, 0.1), new Array(0.05, 1.25, 0.1));
			...
			function materiali(){
				...
				if(textureParametersCopertura.material!=TextureCopertura[textureIndex1]){
				...
				if(textureParametersPlastica.material!=TextureCopertura[textureIndex2]){
					...
					function (obj){
						...
						for(var i=0; i<5; i++){
							OBJModel.material[i] = (new THREE.ShaderMaterial({ uniforms : {
								...
								lightPosition  : { type:"v3v", value: [ new THREE.Vector3(15.0,15.0,15.0),new THREE.Vector3(-15.0,15.0,-15.0),new THREE.Vector3(-15.0,-15.0,15.0),new THREE.Vector3(15.0,-15.0,-15.0)]},
